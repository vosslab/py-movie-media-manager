...
class ImdbScraper(
	...
	Metadata pages are loaded via the browser transport which handles
	WAF JavaScript challenges automatically. Parental guide is handled
	by the separate ImdbParentalGuideScraper.
	"""
	...
	# no API keys required (uses CDN suggestion API)
	requires_keys = []
